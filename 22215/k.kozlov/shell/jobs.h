...
/*
  Опрашивает группу задачи до тех пор, пока группа не исчезнет, то есть не будет получена ошибка ECHILD
  (один из достаточно спорных моментов, потому что на самом деле мы не можем гарантировать, что задача вообще должна завершиться, так что готов убрать использование этой функции)
*/
